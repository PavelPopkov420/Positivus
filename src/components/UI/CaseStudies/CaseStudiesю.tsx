...
export const CaseStudies = () => {
  return (
    <>
      <div className={styles['studies-info']}>
        <ul className={styles['studies-info__list']}>
          <li className={`${styles['studies-info__item']} ${styles['studies-info__item--left']}`}>
            <p className={styles['studies-info__description']}>
              For a local restaurant, we implemented a targeted PPC campaign
              that resulted in a 50% increase in website traffic and a 25%
              increase in sales.
            </p>
            <a href="" className={styles['studies-info__link']}>
          ...
          <li className={`${styles['studies-info__item']} ${styles['studies-info__item--center']}`}>
            <p className={styles['studies-info__description']}>
          ...
          <li className={`${styles['studies-info__item']} ${styles['studies-info__item--right']}`}>
            <p className={styles['studies-info__description']}>
